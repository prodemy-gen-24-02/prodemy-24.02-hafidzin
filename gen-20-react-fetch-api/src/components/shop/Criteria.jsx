...
export default function Criteria({ products }) {
  ...
  return (
    <div className="flex justify-between items-center">
      <div className="flex gap-4 my-4 font-semibold">
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 bg-white py-1 px-2"
          >
        ...
        <div className="relative">
          <button
            onClick={() => setRoast((prev) => !prev)}
            className="flex items-center gap-2 bg-white py-1 px-6"
          >
            Roast: All
            {!roast ? (
              <CaretUp size={18} weight="fill" />
      ...
      <p className="bg-color-primary p-1 font-semibold">
